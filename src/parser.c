...
enum ts_symbol_identifiers {
  ...
  sym_binary_op = 24,
  sym_unary_op = 25,
  sym_binary_special = 26,
  sym_unary_special = 27,
  sym_record = 28,
  sym_tuple = 29,
  sym_list = 30,
  sym_block = 31,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_binary_send] = "binary_send",
  [sym_unary_send] = "unary_send",
  [sym_binary_op] = "binary_op",
  [sym_unary_op] = "unary_op",
  [sym_binary_special] = "binary_special",
  [sym_unary_special] = "unary_special",
  [sym_record] = "record",
  [sym_tuple] = "tuple",
  [sym_list] = "list",
  [sym_block] = "block",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_binary_send] = sym_binary_send,
  [sym_unary_send] = sym_unary_send,
  [sym_binary_op] = sym_binary_op,
  [sym_unary_op] = sym_unary_op,
  [sym_binary_special] = sym_binary_special,
  [sym_unary_special] = sym_unary_special,
...
static const TSCharacterRange sym_send_character_set_2[] = {
  {'!', '!'}, {'$', '&'}, {'*', '+'}, {'-', '-'}, {'/', '/'}, {'<', '@'}, {'^', '^'}, {'|', '|'},
  {'~', '~'},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 3:
      ...
      END_STATE();
    case 4:
      if (set_contains(sym_send_character_set_2, 9, lookahead)) ADVANCE(18);
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
    ...
    case 7:
      ...
      if (set_contains(sym_send_character_set_2, 9, lookahead)) ADVANCE(23);
      END_STATE();
    case 8:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_binary_send] = STATE(79),
    [sym_unary_send] = STATE(79),
    [sym_binary_op] = STATE(79),
    [sym_unary_op] = STATE(79),
    [sym_binary_special] = STATE(79),
    [sym_unary_special] = STATE(79),
    [sym_record] = STATE(79),
    [sym_tuple] = STATE(79),
    [sym_list] = STATE(79),
    [sym_block] = STATE(79),
  ...
  [STATE(2)] = {
    ...
    [sym_binary_send] = STATE(46),
    [sym_unary_send] = STATE(46),
    [sym_binary_op] = STATE(46),
    [sym_unary_op] = STATE(46),
    [sym_binary_special] = STATE(46),
    [sym_unary_special] = STATE(46),
    [sym_record] = STATE(46),
    [sym_tuple] = STATE(46),
    [sym_list] = STATE(46),
    [sym_block] = STATE(46),
  ...
  [STATE(3)] = {
    ...
    [sym_binary_send] = STATE(45),
    [sym_unary_send] = STATE(45),
    [sym_binary_op] = STATE(45),
    [sym_unary_op] = STATE(45),
    [sym_binary_special] = STATE(45),
    [sym_unary_special] = STATE(45),
    [sym_record] = STATE(45),
    [sym_tuple] = STATE(45),
    [sym_list] = STATE(45),
    [sym_block] = STATE(45),
  ...
  [STATE(4)] = {
    ...
    [sym_binary_send] = STATE(47),
    [sym_unary_send] = STATE(47),
    [sym_binary_op] = STATE(47),
    [sym_unary_op] = STATE(47),
    [sym_binary_special] = STATE(47),
    [sym_unary_special] = STATE(47),
    [sym_record] = STATE(47),
    [sym_tuple] = STATE(47),
    [sym_list] = STATE(47),
    [sym_block] = STATE(47),
  ...
  [STATE(5)] = {
    ...
    [sym_binary_send] = STATE(71),
    [sym_unary_send] = STATE(71),
    [sym_binary_op] = STATE(71),
    [sym_unary_op] = STATE(71),
    [sym_binary_special] = STATE(71),
    [sym_unary_special] = STATE(71),
    [sym_record] = STATE(71),
    [sym_tuple] = STATE(71),
    [sym_list] = STATE(71),
    [sym_block] = STATE(71),
  ...
  [STATE(6)] = {
    ...
    [sym_binary_send] = STATE(64),
    [sym_unary_send] = STATE(64),
    [sym_binary_op] = STATE(64),
    [sym_unary_op] = STATE(64),
    [sym_binary_special] = STATE(64),
    [sym_unary_special] = STATE(64),
    [sym_record] = STATE(64),
    [sym_tuple] = STATE(64),
    [sym_list] = STATE(64),
    [sym_block] = STATE(64),
  ...
  [STATE(7)] = {
    ...
    [sym_binary_send] = STATE(70),
    [sym_unary_send] = STATE(70),
    [sym_binary_op] = STATE(70),
    [sym_unary_op] = STATE(70),
    [sym_binary_special] = STATE(70),
    [sym_unary_special] = STATE(70),
    [sym_record] = STATE(70),
    [sym_tuple] = STATE(70),
    [sym_list] = STATE(70),
    [sym_block] = STATE(70),
  ...
  [STATE(8)] = {
    ...
    [sym_binary_send] = STATE(69),
    [sym_unary_send] = STATE(69),
    [sym_binary_op] = STATE(69),
    [sym_unary_op] = STATE(69),
    [sym_binary_special] = STATE(69),
    [sym_unary_special] = STATE(69),
    [sym_record] = STATE(69),
    [sym_tuple] = STATE(69),
    [sym_list] = STATE(69),
    [sym_block] = STATE(69),
  ...
  [STATE(9)] = {
    ...
    [sym_binary_send] = STATE(63),
    [sym_unary_send] = STATE(63),
    [sym_binary_op] = STATE(63),
    [sym_unary_op] = STATE(63),
    [sym_binary_special] = STATE(63),
    [sym_unary_special] = STATE(63),
    [sym_record] = STATE(63),
    [sym_tuple] = STATE(63),
    [sym_list] = STATE(63),
    [sym_block] = STATE(63),
  ...
  [STATE(10)] = {
    ...
    [sym_binary_send] = STATE(65),
    [sym_unary_send] = STATE(65),
    [sym_binary_op] = STATE(65),
    [sym_unary_op] = STATE(65),
    [sym_binary_special] = STATE(65),
    [sym_unary_special] = STATE(65),
    [sym_record] = STATE(65),
    [sym_tuple] = STATE(65),
    [sym_list] = STATE(65),
    [sym_block] = STATE(65),
  ...
  [STATE(11)] = {
    ...
    [sym_binary_send] = STATE(55),
    [sym_unary_send] = STATE(55),
    [sym_binary_op] = STATE(55),
    [sym_unary_op] = STATE(55),
    [sym_binary_special] = STATE(55),
    [sym_unary_special] = STATE(55),
    [sym_record] = STATE(55),
    [sym_tuple] = STATE(55),
    [sym_list] = STATE(55),
    [sym_block] = STATE(55),
  ...
  [STATE(12)] = {
    ...
    [sym_binary_send] = STATE(53),
    [sym_unary_send] = STATE(53),
    [sym_binary_op] = STATE(53),
    [sym_unary_op] = STATE(53),
    [sym_binary_special] = STATE(53),
    [sym_unary_special] = STATE(53),
    [sym_record] = STATE(53),
    [sym_tuple] = STATE(53),
    [sym_list] = STATE(53),
    [sym_block] = STATE(53),
  ...
  [STATE(14)] = {
    ...
    [sym_binary_send] = STATE(73),
    [sym_unary_send] = STATE(73),
    [sym_binary_op] = STATE(73),
    [sym_unary_op] = STATE(73),
    [sym_binary_special] = STATE(73),
    [sym_unary_special] = STATE(73),
    [sym_record] = STATE(73),
    [sym_tuple] = STATE(73),
    [sym_list] = STATE(73),
    [sym_block] = STATE(73),
  ...
  [STATE(17)] = {
    ...
    [sym_binary_send] = STATE(11),
    [sym_unary_send] = STATE(11),
    [sym_binary_op] = STATE(11),
    [sym_unary_op] = STATE(11),
    [sym_binary_special] = STATE(11),
    [sym_unary_special] = STATE(11),
    [sym_record] = STATE(11),
    [sym_tuple] = STATE(11),
    [sym_list] = STATE(11),
    [sym_block] = STATE(11),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_send, 2, 0, 1),
  ...
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_special, 2, 0, 1),
  [37] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_op, 2, 0, 1),
  [41] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_op, 2, 0, 1),
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_send, 2, 0, 1),
  [61] = {.entry = {.count = 1, .reusable = false}}, SHIFT(70),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_special, 2, 0, 1),
  ...
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_special, 3, 0, 2),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_send, 3, 0, 2),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_op, 3, 0, 2),
  ...
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_special, 3, 0, 2),
  [261] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_send, 3, 0, 2),
  [265] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_op, 3, 0, 2),
