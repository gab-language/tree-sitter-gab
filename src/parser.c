...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_builtin, 2, 0, 1),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_builtin, 2, 0, 1),
  ...
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_builtin, 3, 0, 2),
  ...
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_builtin, 3, 0, 2),
